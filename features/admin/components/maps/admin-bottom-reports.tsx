...
interface AdminBottomReportsProps {
...
const BottomTrigger = ({ reports, isMobile, isExpanded }: BottomTriggerProps) => (
...
export default function AdminBottomReports({ reports = [] }: AdminBottomReportsProps) {
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex gap-1.5 pt-0.5">
                                <button
                                    ...
                                    className="w-full h-7.5 bg-slate-100 hover:bg-slate-200 text-gray-700 text-[10px] font-bold uppercase tracking-tighter rounded-md flex items-center justify-center gap-1 transition-all active:scale-95"
                                >
                ...
                <Drawer>
                    <DrawerTrigger asChild>
                        <div className="fixed bottom-4 left-4 right-4 z-40 bg-slate-100/95 backdrop-blur-sm shadow-lg rounded-full border border-red-400 overflow-hidden animate-in fade-in slide-in-from-bottom duration-700">
                            <BottomTrigger reports={reports} isMobile={isMobile} isExpanded={isExpanded} />
                        </div>
                    </DrawerTrigger>
