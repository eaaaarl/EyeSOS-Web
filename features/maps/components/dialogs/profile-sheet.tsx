...
import { LogOut, User, Mail, Phone, Shield, Edit, Settings, Activity, Clock, Bell, Moon } from "lucide-react";
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2.5">
              ...
              <div className="space-y-2">
                <div className="group bg-white hover:bg-gray-50 rounded-lg p-3 border border-gray-200 transition-all flex items-center justify-between">
                  ...
                  <div className="w-8 h-4 bg-green-500 rounded-full relative cursor-pointer shadow-inner">
                ...
                <div className="group bg-white hover:bg-gray-50 rounded-lg p-3 border border-gray-200 transition-all flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-gray-500">System preference</p>
                    </div>
                  </div>
