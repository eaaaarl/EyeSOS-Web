            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2.5">
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-3 border border-green-100">
                  ...
                  <p className="text-base font-bold text-gray-900">On Duty</p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-lg p-3 border border-amber-200">
                ...
                <div className="grid grid-cols-3 gap-2 text-center">
                  <div>
                    ...
                    <p className="text-[10px] text-gray-600 mt-0.5">Total Responses</p>
                  </div>
                  <div>
                    <p className="text-xl font-bold text-gray-900">0</p>
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-600 mt-0.5">Avg. Time</p>
                  </div>
                </div>
              </div>
